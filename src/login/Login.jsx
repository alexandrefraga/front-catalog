        ...
        doLogin(data)
            .then(response => {
                if (response) {
                    ...
                    localStorage.setItem('favorites', response.favorites);
                    console.log('antes...')
                    navigate('/dashboard')
                    console.log('depois...')
                }
                                ...
                                <div className="form-group">
                                    ...
                                    <div className="form-group mb-4">
                                        ...
                                        <div className="input-group">
                                            ...
                                            <input type="password" placeholder="digite sua senha" className="form-control" id="password" onChange={onChangeInput} minLength="6" required />
                                        </div>
                                    </div>
